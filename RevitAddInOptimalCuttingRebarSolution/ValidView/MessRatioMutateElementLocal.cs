...
namespace RevitAddInOptimalCuttingRebarSolution.ValidView
{
    ...
    public class MessRatioMutateElementLocal : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            {
                return textGot.Replace(" ", "") == "" ? "This value is not null" : "Ratio mutate local for each element is a real number >= 0 and <=1 !";
            }
        }
